...
/*global turf, W, $, WazeWrap, WMEWAL, I18n */
import type { WmeSDK, MapComment, Segment, Venue, LonLat } from "wme-sdk-typings";
...
namespace WMEWAL_MapComments {
    ...
    function getPL(mapComment: IMapComment, lonlat: LonLat): string {
